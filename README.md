...
WikiRef is a public domain multiplateform tool built to analyze MediaWiki references, identifies errors, archive reference through WaybackMachine service and create local copy of youtube references.
